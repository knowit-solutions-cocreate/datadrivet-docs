...
- Items in the project come in three different levels:
    ...
    - **features**: larger chunks of work that result in a concrete improvement, should take max 1 week to complete. If you have an idea for a new feature, add it in [the backlog](https://github.com/orgs/knowit-solutions-cocreate/projects/7/views/11). You should mention any added items in standups so that it can be appropriately prioritised as urgent (e.g. bug fixes) or something that we might get to down the line. 
